...
The following plots explore the correlation among quality and the above 
features. This does not imply that only these variables will be explored.
Instead, these are just some initial exploration on some interesting 
observations.
